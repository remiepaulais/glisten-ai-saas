    ...
    >
      <div className='relative'>
        ...
        {isFilled.image(slice.primary.image) && (
          <div className='glass-container relative mt-16 w-fit'>
            <div className='absolute inset-0 -z-10 bg-gradient-to-r from-blue-500/30 to-purple-500/30 blur-2xl filter' />
            <PrismicNextImage
